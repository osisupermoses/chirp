package com.dervlabs.chirp.infra.storage
...
class SupabaseStorageService(
    ...
    fun generateSignedUploadUrl(userId: UserId, mimeType: String): ProfilePictureUploadCredentials {
        ...
        val path = "profile-pictures/$fileName" // "profile-pictures" bucket was initially manually created on Supbase
    ...
    fun deleteFile(url: String) {
        ...
        if (response.statusCode.isError) {
            throw StorageException("Unable to delete file [$url]: ${response.statusCode.value()}")
        }
    }
